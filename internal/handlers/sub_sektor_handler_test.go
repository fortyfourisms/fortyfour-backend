...
func (m *mockSubSektorService) Create(req dto.SubSektorRequest) (*dto.SubSektorResponse, error) {
	if m.CreateFn != nil {
...
func (m *mockSubSektorService) Update(id string, req dto.SubSektorRequest) (*dto.SubSektorResponse, error) {
	if m.UpdateFn != nil {
