...
func TestTokenService_GenerateTokenPair_Success(t *testing.T) {
	...
	// Act
	tokens, err := service.GenerateTokenPair("1", "testuser", "admin", nil)
...
func TestTokenService_RefreshAccessToken_Success(t *testing.T) {
	...
	initialTokens, err := service.GenerateTokenPair("1", "testuser", "admin", nil)
	if err != nil {
...
func TestTokenService_RevokeRefreshToken_Success(t *testing.T) {
	...
	// Generate token pair
	tokens, _ := service.GenerateTokenPair("1", "testuser", "admin", nil)
...
func TestTokenService_RevokeAllUserTokens_HapusSemuaTokenUser(t *testing.T) {
	...
	t1, _ := service.GenerateTokenPair("user-1", "alice", "admin", nil)
	t2, _ := service.GenerateTokenPair("user-1", "alice", "admin", nil)
	t3, _ := service.GenerateTokenPair("user-1", "alice", "admin", nil)

	// User 2 punya token tersendiri
	t4, _ := service.GenerateTokenPair("user-2", "bob", "user", nil)
...
func TestTokenService_RevokeAllUserTokens_TokenTidakBisaDigunakan(t *testing.T) {
	...
	tokens, _ := service.GenerateTokenPair("user-1", "alice", "admin", nil)
