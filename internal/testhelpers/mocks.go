...
func (m *MockIkasRepository) FindPerusahaanByName(namaPerusahaan string) (string, error) {
	// stub sederhana untuk test
	if namaPerusahaan == "" {
		return "", errors.New("nama perusahaan kosong")
	}
	return "perusahaan-id-stub", nil
}
...
// compiler check
var _ repository.IkasRepoInterface = (*MockIkasRepository)(nil)