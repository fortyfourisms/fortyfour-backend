...
// Event
func (p *Producer) PublishEventCreated(ctx context.Context, event dto_event.EventCreatedEvent) error {
	return p.Publish(ctx, "event.events", "event.created", event)
}
func (p *Producer) PublishEventUpdated(ctx context.Context, event dto_event.EventUpdatedEvent) error {
	return p.Publish(ctx, "event.events", "event.updated", event)
}
func (p *Producer) PublishEventDeleted(ctx context.Context, event dto_event.EventDeletedEvent) error {
	return p.Publish(ctx, "event.events", "event.deleted", event)
}

func (p *Producer) PublishEventRegistrationCreated(ctx context.Context, event dto_event.EventRegistrationCreatedEvent) error {
	return p.Publish(ctx, "event.events", "event.registration_created", event)
}
...
// Aktivitas
func (p *Producer) PublishAktivitasCreated(ctx context.Context, event dto_event.AktivitasCreatedEvent) error {
	return p.Publish(ctx, "aktivitas.events", "aktivitas.created", event)
}
func (p *Producer) PublishAktivitasUpdated(ctx context.Context, event dto_event.AktivitasUpdatedEvent) error {
	return p.Publish(ctx, "aktivitas.events", "aktivitas.updated", event)
}
func (p *Producer) PublishAktivitasDeleted(ctx context.Context, event dto_event.AktivitasDeletedEvent) error {
	return p.Publish(ctx, "aktivitas.events", "aktivitas.deleted", event)
}
