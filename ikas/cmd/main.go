...
func main() {
	...
	identifikasiService := services.NewIdentifikasiService(identifikasiRepo, ikasRepo, redisClient)
	proteksiService := services.NewProteksiService(proteksiRepo, ikasRepo, redisClient)
	deteksiService := services.NewDeteksiService(deteksiRepo, ikasRepo, redisClient)
	gulihService := services.NewGulihService(gulihRepo, ikasRepo, redisClient)
	pertanyaanIdentifikasiService := services.NewPertanyaanIdentifikasiService(pertanyaanIdentifikasiRepo, msgProducer, redisClient)
